...
const index = () => {
      return (
            <div className=' bg-white '>
                  <MiniContainer size="sm" className="items-center text-center border-b border-gray-200 m-auto">
                        <div
                        ...
                        >
                              <Image
                                    ...
                                    fill
                              />
                              <span className="absolute bottom-6 right-1 w-4 h-4 bg-tertiary rounded-full border-2 border-white" />
                        </div>
                        <div
                              className=" m-auto p-7"
                        >
                              <p className="font-semibold text-gray-800">Juan Carlos Gómez Jaramillo</p>
                  ...
                  <div>
                        <MiniContainer
                              size="sm"
                              className="mt-5  border-b border-gray-200 m-auto "
                        >
                              {[
                                    { label: 'Age', value: '46' },
                                    ...
                                    <div key={label} className="flex justify-between items-center text-sm">
                                          ...
                                          <span className={highlight ? 'text-green-500 font-medium' : 'text-gray-700'}>
                                                {value}
                                          </span>
                                    </div>
                              ))}
                  ...
                  <div>
                        <MiniContainer size="sm" className="mt-5  border-b border-gray-200 m-auto" title="Languages" >
                  ...
                  <div>
                        <MiniContainer size="sm" className="mt-5  border-b border-gray-200 m-auto" title="Programming-languages" >
                              ...
                              <SkillBar language="Python" percentage={80} />
                              <SkillBar language="Kotlin" percentage={75} />
                        </MiniContainer>
                  </div>
